...
class movements // movements of the game including pass , dribble , tackle , shoot and save
{
    ...
    void default_accuracy (int option) // the accuracy of the team made by player
    {
        switch (option)
        {
...
class team // each team in the game
{
    ...
    void complete (int team_number)// sets each team with its attributes' accuracy
    {
        switch ( team_number )
        {
    ...
    void add_gems(int round)// adding gems in the rounds
    {
        if ( round <= 2 )
            GEMS+=10;
        else
